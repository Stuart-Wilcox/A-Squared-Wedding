			...
			&&	$header.hasClass('alt')) {
				...
				$window.on('load', function() {
					...
					$banner.scrollex({
						...
						enter:		function() { $header.addClass('alt'); $("#tagline").hide(); },
						leave:		function() { $header.removeClass('alt'); $header.addClass('reveal'); $("#tagline").show(); }
					});
...
$(window).load(bgImgResize);
$(window).resize(bgImgResize);
